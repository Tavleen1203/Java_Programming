...
public class NextLargest {
	public static TreeNode<Integer> result ;
	...
	public static TreeNode<Integer> nextLargerElement(TreeNode<Integer> root, int n){
		...
		if(root.data > n && (result==null || root.data < result.data)) {
			result = root;
		}
		
		for(TreeNode<Integer> child : root.children) {
			nextLargerElement(child, n);
		}
	...
	public static void main(String[] args) {
		...
		printLevelwise(root);
		TreeNode<Integer> result=nextLargerElement(root, 33);
